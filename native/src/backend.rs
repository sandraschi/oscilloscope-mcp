...
const BACKEND_NAME: &str = "oscilloscope-mcp-backend.exe";
const BACKEND_PORT: u16 = 10936;
const BACKEND_TAG: &str = "oscilloscope-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "OSCILLOSCOPE_MCP_PORT";
const ENV_HOST: &str = "OSCILLOSCOPE_MCP_HOST";
const ENV_TAURI: &str = "OSCILLOSCOPE_MCP_TAURI";
